...
const GradientGrid = (props) => {
    ...
    var colors = dataIndex.divergent
    if (indexName !== 'CDD' && indexName !== 'PRCPTOT' && indexName !== 'CSDI'){
        colors = dataIndex.divergentReverse
    }
